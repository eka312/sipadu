    ...
    <div class="w-full max-w-[420px] bg-white rounded-[20px] login-card overflow-hidden">
        ...
        <div class="px-10 py-10">
            <div class="text-center mb-8">
                <h2 class="text-[20px] font-bold text-gray-800">Login Guru</h2>
                <p class="text-sm text-gray-400 mt-1">Silakan masuk menggunakan akun resmi Anda</p>
            </div>
            @if ($errors->any())
            ...
            <form action="{{ route('login.guru') }}" method="POST">
                ...
                @method('POST')
                <div class="mb-5">
                    <label class="block text-[13px] font-medium text-gray-600 mb-2">No Identitas / Email</label>
                    <div class="relative group">
                        ...
                        <input type="text"
                            ...
                            placeholder="1980123456 / guru@email.com" name="login">
                    </div>
                </div>
